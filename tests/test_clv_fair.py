...
class TestFaireEinstiegsWahrscheinlichkeit(unittest.TestCase):
    ...
    def test_nicht_1x2_maerkte_werden_nicht_angefasst(self):
        self.assertIsNone(R.fair_entry_prob({"hw": 2.0, "dr": 3.6, "aw": 3.9}, "Über 2.5 Tore"))
...
class TestAmEchtenBestand(unittest.TestCase):
    ...
    def test_die_korrektur_hebt_den_clv_an_und_zwar_spuerbar(self):
        ...
        self.assertGreaterEqual(len(paare), 15, "zu wenig zuordenbare Picks fuer die Aussage")

...
─────────────────────────────────────────────────────────────────
  🇧🇪 Jupiler Pro League  (rl=6)
─────────────────────────────────────────────────────────────────
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 26.04.2026  Gent vs Club Brugge KV
...
─────────────────────────────────────────────────────────────────
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 27.04.2026  Manchester United vs Brentford
     H2H Schnitt=3.5 Tore (≥3.0). Under 2.5 Pick wäre kontraindiziert — JS H2H-Guard muss sc -= 0.30+ anwenden. Falls Under-Pick trotzdem erscheint: H2H-Guard-Bug.
...
─────────────────────────────────────────────────────────────────
  🟡 WARNUNG [BOTH_LOW_MOTIV_HIGH_SCORE]
     ...
     Beide Teams motivationLevel='low' (fast am Ziel) aber matchScore=10.0. Intensitäts-Einschätzung könnte zu hoch sein.
  🔴 FEHLER [PRESSURE_MUSTWINFLAG_MISMATCH]
     📅 26.04.2026  Oviedo vs Elche
     Oviedo: pressureRatio=0.87 > 0.65 aber mustWin=False. calc_pressure() hat mustWin-Flag nicht korrekt gesetzt.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  Oviedo vs Elche
  ...
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 26.04.2026  Villarreal vs Celta Vigo
     H2H Schnitt=3.7 Tore (≥3.0). Under 2.5 Pick wäre kontraindiziert — JS H2H-Guard muss sc -= 0.30+ anwenden. Falls Under-Pick trotzdem erscheint: H2H-Guard-Bug.
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 27.04.2026  Espanyol vs Levante
     H2H Schnitt=3.1 Tore (≥3.0). Under 2.5 Pick wäre kontraindiziert — JS H2H-Guard muss sc -= 0.30+ anwenden. Falls Under-Pick trotzdem erscheint: H2H-Guard-Bug.
...
─────────────────────────────────────────────────────────────────
  ...
  🟡 WARNUNG [BOTRED_ASYMMETRIC_PRESSURE]
     📅 26.04.2026  Le Havre vs Metz
     Kellerduell-Narrativ aber asymmetrischer Druck: Le Havre pressureRatio=0.33 vs Metz pressureRatio=0.00. Nur eine Mannschaft kämpft wirklich — Angle zu vereinfacht.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  Le Havre vs Metz
     matchScore=10.6 aber kein Team mit mustWin. Prüfe ob Score durch andere Faktoren gerechtfertigt ist (H2H, Form, Runden).
  🟡 WARNUNG [HOME_POOR_FORM_HIGH_SCORE]
     📅 26.04.2026  Le Havre vs Metz
     Le Havre: formScore=0.22 (sehr schwach) aber matchScore=10.6. Pick-Basis könnte überschätzt sein — Formeinbruch nicht ausreichend gewichtet.
...
─────────────────────────────────────────────────────────────────
  🔴 FEHLER [PRESSURE_MUSTWINFLAG_MISMATCH]
     ...
     VfB Stuttgart: pressureRatio=0.89 > 0.65 aber mustWin=False. calc_pressure() hat mustWin-Flag nicht korrekt gesetzt.
  🟡 WARNUNG [CONFIRMED_NONE_WITH_PRESSURE]
     📅 26.04.2026  VfB Stuttgart vs Werder Bremen
     VfB Stuttgart: motivationLevel='none' (bestätigt) aber pressureRatio=0.89 > 0. Bestätigtes Team darf keine Pressure haben — calc_motivation() prüfen.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  VfB Stuttgart vs Werder Bremen
...
─────────────────────────────────────────────────────────────────
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 26.04.2026  Fiorentina vs Sassuolo
     H2H Schnitt=3.5 Tore (≥3.0). Under 2.5 Pick wäre kontraindiziert — JS H2H-Guard muss sc -= 0.30+ anwenden. Falls Under-Pick trotzdem erscheint: H2H-Guard-Bug.
  🔵 HINWEIS [STRONG_H2H_LOW_SCORE]
...
─────────────────────────────────────────────────────────────────
  ...
  🟡 WARNUNG [BOTRED_ASYMMETRIC_PRESSURE]
     ...
     Kellerduell-Narrativ aber asymmetrischer Druck: FC Volendam pressureRatio=0.44 vs Heracles pressureRatio=0.00. Nur eine Mannschaft kämpft wirklich — Angle zu vereinfacht.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  Heracles vs FC Volendam
     matchScore=10.7 aber kein Team mit mustWin. Prüfe ob Score durch andere Faktoren gerechtfertigt ist (H2H, Form, Runden).
  🟡 WARNUNG [HOME_POOR_FORM_HIGH_SCORE]
     📅 26.04.2026  Heracles vs FC Volendam
     Heracles: formScore=0.11 (sehr schwach) aber matchScore=10.7. Pick-Basis könnte überschätzt sein — Formeinbruch nicht ausreichend gewichtet.
  🟡 WARNUNG [BOTH_DEFENSIVE_OVER_RISK]
     📅 26.04.2026  Heracles vs FC Volendam
...
─────────────────────────────────────────────────────────────────
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 26.04.2026  Santa Clara vs SC Braga
     H2H Schnitt=3.1 Tore (≥3.0). Under 2.5 Pick wäre kontraindiziert — JS H2H-Guard muss sc -= 0.30+ anwenden. Falls Under-Pick trotzdem erscheint: H2H-Guard-Bug.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
  ...
  🟡 WARNUNG [MUSTWIN_LOW_GPG]
     📅 27.04.2026  GIL Vicente vs Casa Pia
     Casa Pia: mustWin=True aber nur 0.3 Tore/Spiel — Pick 'muss gewinnen' bei Teams die kaum treffen ist unrealistisch.
  🔵 HINWEIS [LOW_GOALS_UNDER_EXPECTED]
     📅 27.04.2026  GIL Vicente vs Casa Pia
     H2H Schnitt=1.5 + Saisonschnitt komb.=1.8/Sp. Starker Under-Bias legitim — kein Fehler. Over 2.5 Pick hier wäre falsch.
...
─────────────────────────────────────────────────────────────────
  🔴 FEHLER [PRESSURE_MUSTWINFLAG_MISMATCH]
     ...
     Rangers: pressureRatio=0.87 > 0.65 aber mustWin=False. calc_pressure() hat mustWin-Flag nicht korrekt gesetzt.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  Rangers vs Motherwell
     matchScore=9.1 aber kein Team mit mustWin. Prüfe ob Score durch andere Faktoren gerechtfertigt ist (H2H, Form, Runden).
...
─────────────────────────────────────────────────────────────────
  🟡 WARNUNG [H2H_HIGH_AVG_UNDER_RISK]
     📅 26.04.2026  BSC Young Boys vs FC ST. Gallen
     H2H Schnitt=3.4 Tore (≥3.0). Under 2.5 Pick wäre kontraindiziert — JS H2H-Guard muss sc -= 0.30+ anwenden. Falls Under-Pick trotzdem erscheint: H2H-Guard-Bug.
  🟡 WARNUNG [BOTRED_ASYMMETRIC_PRESSURE]
     📅 26.04.2026  Servette FC vs FC Winterthur
     Kellerduell-Narrativ aber asymmetrischer Druck: Servette FC pressureRatio=0.56 vs FC Winterthur pressureRatio=0.00. Nur eine Mannschaft kämpft wirklich — Angle zu vereinfacht.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  Servette FC vs FC Winterthur
...
─────────────────────────────────────────────────────────────────
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]
     📅 26.04.2026  Gençlerbirliği S.K. vs Kocaelispor
     matchScore=9.0 aber kein Team mit mustWin. Prüfe ob Score durch andere Faktoren gerechtfertigt ist (H2H, Form, Runden).
  🟡 WARNUNG [HOME_POOR_FORM_HIGH_SCORE]
     📅 26.04.2026  Gençlerbirliği S.K. vs Kocaelispor
     Gençlerbirliği S.K.: formScore=0.17 (sehr schwach) aber matchScore=9.0. Pick-Basis könnte überschätzt sein — Formeinbruch nicht ausreichend gewichtet.
  🔵 HINWEIS [HIGH_SCORE_NO_MUSTWИН]

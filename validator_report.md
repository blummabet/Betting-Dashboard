# 🟡 Picks Validator — 16.09.2026 14:56

**74 Spiele geprüft** · 🔴 0 Fehler · 🟡 49 Warnungen · 🔵 234 Hinweise
...
─────────────────────────────────────────────────────────────────
  ...
  🔵 HINWEIS [LOW_SCORING_PROFILE]
     📅 19.09.2026  Tottenham vs Aston Villa
     Ø gpg=1.80, H2H Ø=3.0 Tore — Niedrig-Scoring-Profil, Over-Pick durch Hard Gate automatisch unterdrückt
  🔵 HINWEIS [OVER35_LOW_FV]
     📅 19.09.2026  Tottenham vs Aston Villa
     Ø gpg=1.80 (statischer Proxy) → Poisson FV für Over 3.5 = 10.9%. JS nutzt expGoals aus xG/Att-Strength — FV-Gate greift dort zuverlässiger als dieser Proxy.
  🔵 HINWEIS [TEAM_OVER_AWAY_LOW_FV]
     📅 19.09.2026  Tottenham vs Aston Villa
     Aston Villa expA≈1.15 (statischer Proxy) → FV über 1.5 = 31.9%. JS-expA aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
  🔵 HINWEIS [CARDS45_LOW_FV]
  ...
  🔵 HINWEIS [TEAM_OVER_AWAY_LOW_FV]
     📅 19.09.2026  Everton vs Ipswich
     Ipswich expA≈1.35 (statischer Proxy) → FV über 1.5 = 39.1%. JS-expA aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
  🔵 HINWEIS [CARDS45_LOW_FV]
  ...
  🔵 HINWEIS [LOW_SCORING_PROFILE]
     📅 19.09.2026  Nottingham Forest vs Coventry
     Ø gpg=2.00, H2H Ø=2.6 Tore — Niedrig-Scoring-Profil, Over-Pick durch Hard Gate automatisch unterdrückt
  🔵 HINWEIS [OVER35_LOW_FV]
     📅 19.09.2026  Nottingham Forest vs Coventry
  ...
  🔵 HINWEIS [TEAM_OVER_AWAY_LOW_FV]
     📅 19.09.2026  Nottingham Forest vs Coventry
     Coventry expA≈1.00 (statischer Proxy) → FV über 1.5 = 26.4%. JS-expA aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
...
─────────────────────────────────────────────────────────────────
  ...
  🟡 WARNUNG [HOME_POOR_FORM_HIGH_SCORE]
     ...
     Celta Vigo: formScore=0.22 (sehr schwach) aber matchScore=7.5. Pick-Basis könnte überschätzt sein — Formeinbruch nicht ausreichend gewichtet.
  🔵 HINWEIS [LOW_MOTIV_CARDS_CHECK]
     📅 19.09.2026  Celta Vigo vs Racing Santander
  ...
  🔵 HINWEIS [TEAM_OVER_HOME_LOW_FV]
     📅 19.09.2026  Celta Vigo vs Racing Santander
     Celta Vigo expH≈1.10 (statischer Proxy) → FV über 1.5 = 30.1%. JS-expH aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
  🔵 HINWEIS [TEAM_OVER_AWAY_LOW_FV]
     📅 19.09.2026  Celta Vigo vs Racing Santander
     Racing Santander expA≈1.35 (statischer Proxy) → FV über 1.5 = 39.1%. JS-expA aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
  🔵 HINWEIS [CARDS35_LOW_FV]
  ...
  🔵 HINWEIS [TEAM_OVER_HOME_LOW_FV]
     📅 19.09.2026  Sevilla vs Barcelona
     Sevilla expH≈1.15 (statischer Proxy) → FV über 1.5 = 31.9%. JS-expH aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
...
─────────────────────────────────────────────────────────────────
  ...
  🔵 HINWEIS [TEAM_OVER_AWAY_LOW_FV]
     📅 19.09.2026  Lyon vs Rennes
     Rennes expA≈1.30 (statischer Proxy) → FV über 1.5 = 37.3%. JS-expA aus xG/Att-Strength typischerweise höher — Gate greift dort zuverlässiger.
  🔵 HINWEIS [CARDS35_LOW_FV]
...
─────────────────────────────────────────────────────────────────
  ...
  🔵 HINWEIS [LOW_MOTIV_CARDS_CHECK]
     ...
     FC Luzern, Grasshoppers: motivationLevel='low' (fast gerettet) — Karten-Pick nur mit Schiedsrichter-Evidenz sinnvoll. Kein Fehler — manuell prüfen.
  🔵 HINWEIS [CARDS35_LOW_FV]
     📅 19.09.2026  FC Luzern vs Grasshoppers
     Liga-Baserate=3.4 → Poisson FV für Über 3.5 Karten = 44.2% (typische Quote ~1.80 → impl.Prob ~55.6%; Lücke ~+11.4%). FV-Gate (GOALS_REAL=0.05 → flaggt unter 50.6%) sollte Karten-3.5-Pick blocken. Kein refAvg im Validator — JS-Ergebnis kann durch hohen refAvg abweichen.
  🔵 HINWEIS [CARDS45_LOW_FV]
...
═════════════════════════════════════════════════════════════════
  Geprüft: 74 Spiele
  🟡 49 Warnungen — manuelle Prüfung empfohlen
  🔵 234 Hinweise — Pick-Richtung kontrollieren
═════════════════════════════════════════════════════════════════

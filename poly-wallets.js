...
function _pwDominanz(rec){
  const kopf='<section class="pw-sec"><div class="pw-sec-head">'
    ...
    +'<span class="pw-sec-note">Positionen ab <b>$3.000</b>, die mindestens <b>40 %</b> des '
    +'Geldes auf <b>ihrer eigenen Seite</b> ausmachen. Gehen in den <b>Trades</b>-Channel, nicht in den Public. '
    +'⚖️ <b>Seite, nicht Gesamtmarkt</b> — seit 11.09.2026: bei Polymarket ist '
    +'<code>usd = Anteile × Preis</code>, also zählte dieselbe Stückzahl auf einem Favoriten @0,87 '
    +'als 6,7× so viel „Dominanz" wie auf einem Außenseiter @0,13. Das Band fand fast nur '
    +'Favoriten (80 % der Treffer unter Quote 1,35), und der Quotenboden warf sie wieder raus — '
    +'zwei Regeln aus demselben Messfehler. Am Anteil der eigenen Seite kürzt sich der Preis '
    +'heraus: der Drall verschwindet (Median-Quote 2,00 / 2,15 / 1,98 / 1,74 über die Bänder, '
    +'kein Trend), es gibt 43 statt 5 Kandidaten, und 77 % davon liegen über 1,35 statt 20 %. '
    +'Gebucht werden beide Maße plus der Nenner, damit sich nachrechnen lässt, ob es getragen hat. '
